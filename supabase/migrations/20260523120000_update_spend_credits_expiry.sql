-- Redefine spend_credits_for_pack to set license expires_at to exactly 1 week from now
...
BEGIN
  ...
  CASE _pack
    WHEN 'iso9001' THEN cost:=1; naira:=5000;
    WHEN 'iso14001' THEN cost:=1; naira:=5000;
    WHEN 'iso45001' THEN cost:=1; naira:=5000;
    WHEN 'iso27001' THEN cost:=1; naira:=5000;
    WHEN 'hse' THEN cost:=2; naira:=10000;
    WHEN 'ims' THEN cost:=3; naira:=15000;
