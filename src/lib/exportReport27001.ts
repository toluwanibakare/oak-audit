...
export function exportReport27001({ meta, statuses, notes, findings, findingsMeta = {} }: ExportArgs) {
...
<head>
  <meta charset="utf-8" />
  <title>ISO 27001 Audit Report — ${esc(meta.organization || "Organization")}</title>
  <style>
...
<body>
  ...
  <table class="meta">
    ...
    <tr><td>Standard</td><td>ISO/IEC 27001:2022 (clauses 4–10) + Annex A controls</td></tr>
    <tr><td>Report generated</td><td>${today}</td></tr>
  </table>

  <h2>1. Executive Summary</h2>
  <p style="font-size:13.5px; color:#334155;">
    The audit evaluated <strong>${total}</strong> management system clauses under the ISO/IEC 27001:2022 standard. 
  ...
  <table class="stats-table">
    ...
    <tbody>
      <tr>
        ...
        <td>A systemic failure or lack of implementation of a standard requirement, indicating a significant risk to the integrity of the ISMS.</td>
        <td style="text-align: center; font-weight: 700; color: #be123c;">${counts.major}</td>
      </tr>
      <tr>
        <td><strong>Minor Nonconformity</strong></td>
        <td>An isolated lapse or minor compliance gap that does not compromise the overall systemic operation of the ISMS.</td>
  ...
  <div class="conformity-box">
    <div class="conformity-title">Overall ISMS Conformity Rate</div>
  ...
  <h2>3. Annex A control themes (referenced via SoA)</h2>
  <p style="font-size:13.5px; color:#334155; margin-bottom: 12px;">
    Annex A controls were reviewed using a sampling method across primary themes defined in ISO/IEC 27001:2022. The detailed compliance elements were integrated within the audited organizational processes:
  </p>
  <table>
    <thead>
      <tr>
        ...
        <th>Name</th>
        <th style="width:80px; text-align: center;">Controls</th>
        <th>Examples & Sampling Items</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td>${esc(t.examples)}</td>
      </tr>`).join("")}
    </tbody>
  </table>

  <h2>4. System & Clause Compliance Summary</h2>
  <table>
    <thead>
      <tr>
      ...
      <div class="grc-section">
        ...
        <table class="grc-table">
          <tr>
            ...
            <td><strong>${esc(itemMeta.owner || "CISO (to assign)")}</strong></td>
          </tr>
          <tr>
  ...
  <h2>6. Audit Conclusions & Strengths</h2>
  ...
  <table class="meta" style="margin-top: 20px;">
    <tr>
      ...
      <td style="width: 33%;"><strong>Reviewed by (CISO / ISMS Manager)</strong></td>
  ...
  <footer>
    <span class="confidential-stamp">CONFIDENTIAL</span> · Generated by OAK Global International · ISO/IEC 27001:2022 Audit Report
  </footer>
