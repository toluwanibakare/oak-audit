...
const HSE_QUESTIONS: Record<HseProcessKey, ClauseQuestionSet[]> = {
  ...
  hse_contractor: [
    ...
    { clause: "130", title: "Contractor Evaluation", generic: ["Is contractor safety performance evaluated?"], specific: ["Check post-project ISO contractor rating cards for renewals."], evidence: ["Performance reviews, rating matrix."] },
  ],
  hse_permit: [
    ...
    { clause: "140", title: "Permit Records Retention", generic: ["Are permit records retained?"], specific: ["Check archive boxes or ISO database folders for expired permits."], evidence: ["Permit files, historical compliance storage."] },
  ],
  hse_management: [
    ...
    { clause: "145", title: "Corrective Actions Tracking", generic: ["Are corrective actions tracked?"], specific: ["Ensure ISO registers track action status, owners, and closure proof."], evidence: ["Corrective action register, CAPA system updates."] },
