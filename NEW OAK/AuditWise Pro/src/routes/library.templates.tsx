...
export const Route = createFileRoute("/library/templates")({
  ...
  head: () => ({ meta: [{ title: "Templates — AuditOS" }, { name: "description", content: "Templates module of the AuditOS ISO management platform." }] }),
  component: Page,
});

function Page() {
  return (
    <ModulePage annotation="09 · LIBRARY" title="Templates">
