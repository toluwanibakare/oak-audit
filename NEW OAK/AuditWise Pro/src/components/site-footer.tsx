        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:info@oak-global.com.ng" className="flex items-center gap-2.5 text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
